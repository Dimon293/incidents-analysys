...
<v-row>
              ...
              <v-col
                ...
                class="wrap_graph"
              >
                <h4 justify="center" class="font-weight-light">
                  Производитель ТС
                </h4>
                <pie-chart
                  v-if="!progressBar"
            ...
            </v-row>        <v-container fluid class="data_container">
          <v-layout column>
              ...
              <v-app>
                <v-data-table
                  ...
                  ><v-progress-linear
                    ...
                    color="green"
                    indeterminate
                  ></v-progress-linear> </v-data-table
              ></v-app>
            </v-flex>
          </v-layout>
        </v-container>
  ...
  data() {
    return {
      ...
      items: [{
        ...
        start_lat: 53.298270,
        end_lat: 53.299016,
        start_long: 34.307594,
        end_long: 34.310641,
        cluster: "Высокая аварийность",
      },
      {
        distr:'Брянск',
        start_lat: 53.310851,
        end_lat: 53.311904,
        start_long: 34.304615,
        end_long: 34.307061,
        cluster: "Средняя аварийность",
      },
      {
        distr:'Брянск',
        start_lat: 53.295550,
        end_lat: 53.295859,
        start_long: 34.259494,
        end_long: 34.261253,
        cluster: "Низкая аварийность",
      },
      {
        distr:'Брянск',
        start_lat: 53.298270,
      ...
      headers: [
        { text: "Район", value: "distr" },
        { text: "Начальная широта", value: "start_lat" },
        { text: "Конечная широта", value: "end_lat" },
        { text: "Начальная долгота", value: "start_long", },
        { text: "Конечная долгота", value: "end_long" },
        { text: "Категория", value: "cluster" },
      ],
      menu: false,
