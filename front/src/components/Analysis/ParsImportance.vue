  ...
  <v-app>
    <v-container fluid>
      <v-main>
        <v-container fluid>
          <v-row id="first">
            <v-col lg="8" sm="8" cols="12" class="pa-1 ma-0"
              ><v-select
                @change="generateUrl"
...
export default {
  ...
  data() {
    return {
      ...
      progressBar: false,
      items: [{
        field: 'Освещение на участке движения',
        subject: "",
        start_date: "2015-01",
        end_date: "2020-12",
        x_value: 0.578,
        y_value: 4.934,
        cluster: 'Средне влияющий фактор'
      },
      {
        field: 'Пол',
        subject: "",
        ...
        x_value: 0.743,
        y_value: 7.151,
        cluster: 'Сильно влияющий фактор'

      },
      {
        field: 'Год производства ТС',
        subject: "",
        start_date: "2015-01",
        end_date: "2020-12",
        x_value: 0.257,
      ...
      headers: [
        ...
        { text: "Начальная дата", value: "start_date" },
        { text: "Конечная дата", value: "end_date" },
        { text: "Кластер", value: "cluster" },
        { text: "Значение Х", value: "x_value" },
        { text: "Значение Y", value: "y_value" },
      ],
      menu: false,
      coords: [],
    };
